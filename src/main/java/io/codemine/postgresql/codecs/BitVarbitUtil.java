...
/** Shared encode/decode logic for both {@link BitCodec} and {@link VarbitCodec}. */
final class BitVarbitUtil {

  private BitVarbitUtil() {}

  static void write(StringBuilder sb, Bit value) {
  ...
  static Codec.ParsingResult<Bit> parse(CharSequence input, int offset)
  ...
  static void encodeInBinary(Bit value, ByteArrayOutputStream out) {
  ...
  static Bit decodeInBinary(ByteBuffer buf, int length) {
  ...
  static Bit random(Random r, int size) {
