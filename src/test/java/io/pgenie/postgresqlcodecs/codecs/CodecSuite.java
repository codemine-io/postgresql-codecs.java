...
abstract class CodecSuite<A> {
    ...
    /**
     * R2DBC connection factory whose codec sends parameters in <b>binary</b>
     * format and expects results in <b>binary</b> format
     * ({@code forceBinary=true}).
     */
    private final PostgresqlConnectionFactory binaryInBinaryOutFactory;

    /**
     * R2DBC connection factory whose codec sends parameters in <b>text</b>
     * format and expects results in <b>text</b> format (no
     * {@code forceBinary}).
     */
    ...
    private PostgresqlConnectionFactory r2dbcFactory(
            boolean forceBinary,
            io.r2dbc.postgresql.codec.Codec<A> r2dbcCodec) {
