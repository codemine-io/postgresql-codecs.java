...
[![maven](https://img.shields.io/badge/maven-dev-green)](https://codemine.io/postgresql-codecs.java/latest/)
[![javadoc](https://img.shields.io/badge/javadoc-dev-green)](https://codemine.io/postgresql-codecs.java/latest/apidocs/)
[![Maven Central Version](https://img.shields.io/maven-central/v/io.codemine.java.postgresql/codecs)](https://central.sonatype.com/artifact/io.codemine.java.postgresql/codecs)
...
Where applicable the library-specific types expose JDK bridge helpers.
...
For connections without `forceBinary`, you can use [the adapter in Text format](./src/test/java/io/codemine/java/postgresql/TextInTextOutR2dbcCodec.java) instead.
